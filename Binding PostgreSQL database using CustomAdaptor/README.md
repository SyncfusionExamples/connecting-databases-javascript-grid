## JavaScript Grid PostgreSQL Server connectivity using CustomAdaptor

A project that enables data binding and CRUD action handling in the Syncfusion JavaScript Grid to a PostgreSQL Server using CustomAdaptor feature of the Grid.
