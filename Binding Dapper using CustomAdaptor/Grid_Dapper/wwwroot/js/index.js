...
let data = new ej.data.DataManager({
    url: 'https://localhost:7160/api/Grid',
    insertUrl: 'https://localhost:7160/api/Grid/Insert',
    updateUrl: 'https://localhost:7160/api/Grid/Update',
    removeUrl: 'https://localhost:7160/api/Grid/Remove',
    batchUrl: 'https://localhost:7160/api/Grid/BatchUpdate',
