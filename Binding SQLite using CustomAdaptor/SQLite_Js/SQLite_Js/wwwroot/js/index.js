import { CustomAdaptor } from '/js/CustomAdaptor.js';
ej.grids.Grid.Inject(ej.grids.Toolbar, ej.grids.Edit, ej.grids.Filter, ej.grids.Page);

var data = new ej.data.DataManager({
    url: 'https://localhost:7061/api/Grid',
    insertUrl: 'https://localhost:7061/api/Grid/Insert',
    updateUrl: 'https://localhost:7061/api/Grid/Update',
    removeUrl: 'https://localhost:7061/api/Grid/Remove',
   // batchUrl: 'https://localhost:7061/api/Grid/BatchUpdate',
