let data = new ej.data.DataManager({
    url: 'https://localhost:7235/api/Grid',
    insertUrl: 'https://localhost:7235/api/Grid/Insert',
    updateUrl: 'https://localhost:7235/api/Grid/Update',
    removeUrl: 'https://localhost:7235/api/Grid/Remove',
    batchUrl: 'https://localhost:7235/api/Grid/BatchUpdate',
