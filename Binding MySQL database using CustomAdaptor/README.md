## JavaScript Grid MYSQL connectivity using CustomAdaptor

A project that enables data binding and CRUD action handling in the Syncfusion JavaScript Grid to a MYSQL Server using CustomAdaptor feature of the Grid.
