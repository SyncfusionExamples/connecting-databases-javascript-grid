## JavaScript Grid SQL Server Connectivity using Dapper and URLAdaptor

A project that enables data binding and CRUD action handling in the Syncfusion JavaScript Grid to a SQL Server using Dapper (mapping tool) and URLAdaptor feature of the Grid.
